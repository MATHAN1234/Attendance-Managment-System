...
public class MODIFYSTUDENT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SearchStudentbtn1 = new javax.swing.JButton();
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 460, 70, 30));

        jLabel9.setBackground(new java.awt.Color(0, 0, 0));
        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel9.setText("SEARCH");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 70, 30));
        ...
        jPanel2.add(SearchStudentbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, 118, 30));
        ...
        btnStudentSFemale.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnStudentSFemaleActionPerformed(evt);
            }
        });
        ...
        SearchStudentbtn1.setBackground(new java.awt.Color(97, 212, 195));
        SearchStudentbtn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Capture15.PNG"))); // NOI18N
        SearchStudentbtn1.setText("SEARCH");
        SearchStudentbtn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SearchStudentbtn1ActionPerformed(evt);
            }
        });
        jPanel2.add(SearchStudentbtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 460, 118, 30));
        ...
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 190, 190, -1));
    ...
    private void SearchStudentbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchStudentbtn1ActionPerformed
            String StudentID= IDSEARCHSTUDENT.getText();
            String IDNO = btnStudentSID.getText();
            String Name = btnStudentSName.getText();
            String Password = btnStudentSPassword.getText();
            String DOB = btnStudentSDOB.getText();
            String Nationality = btnStudentSNat.getText();
            String intake =(String) SelectSearchIntake.getSelectedItem();
        
        
        
        ArrayList<Student1> StudentList = new ArrayList<>();
     
        if (StudentID.isEmpty() || IDNO.isEmpty() || Name.isEmpty() || Password.isEmpty() || DOB.isEmpty() 
                || Nationality.isEmpty() || intake.isEmpty() ) {
        ...
        try {
            ...
            while ((data = br.readLine()) != null) {
                        UpdateStudent = new Student1(data);
                        if (UpdateStudent.getidno().equals(StudentID)) {
                            UpdateStudent.setname(Name);
                            UpdateStudent.setpassword(Password);
                            UpdateStudent.setgender(Gender);
                            UpdateStudent.setdob(DOB);
                            UpdateStudent.setnationality(Nationality);  
                            UpdateStudent.setIntake(intake);
                             }
    ...
    }//GEN-LAST:event_SearchStudentbtn1ActionPerformed
    ...
    private void btnStudentSFemaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStudentSFemaleActionPerformed
         if(btnStudentSFemale.isSelected())
        btnStudentSMale.setSelected(false);
        Gender = "Female";
    }//GEN-LAST:event_btnStudentSFemaleActionPerformed
